...
# ============================================================================
python2.7 ./RankingBanditExperiment.py -q all -m all -n $1 -w 40 -c 5 --regret RelativeRankingAlgorithm -a 0.5 -f RefinedSkipClickLambdasAlgorithm experiments/RelativeRankingAlgorithm_Horizon$1
echo "Done with RR!"
date
